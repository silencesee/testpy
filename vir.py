...
#     l=attack()
# 打包代码
# pyinstaller -F -n pyRSA_single_re_c --clean --uac-admin -w -i icos\imageres_106.ico RSA_single_re_c.py
# 界面版的打包，关键参数-w/c决定是否有console
# pyinstaller -F -n pyRSA_single_re --clean --uac-admin -c -i icos\imageres_106.ico RSA_single_re.py
